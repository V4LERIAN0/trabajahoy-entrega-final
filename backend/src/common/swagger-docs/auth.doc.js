 ...
 *     description: Creates a new user account with candidate role. Returns access and refresh tokens.
 *     tags: [Auth]
 *     requestBody:
 *       required: true
 *       content:
 ...
 *     description: Returns the authenticated user's profile information with roles.
 *     tags: [Auth]
 *     security:
 *       - BearerAuth: []
 *     responses:
